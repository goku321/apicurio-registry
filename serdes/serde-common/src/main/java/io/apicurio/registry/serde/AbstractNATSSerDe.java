 ...
 * @param <U>
 */
public abstract class AbstractNATSSerDe<T, U> extends SchemaResolverConfigurer<T, U> {
    ...
    public AbstractNATSSerDe() {
        super();
    }

    public AbstractNATSSerDe(RegistryClient client) {
        super(client);
    }

    public AbstractNATSSerDe(io.apicurio.registry.resolver.SchemaResolver<T, U> schemaResolver) {
        super(schemaResolver);
    }

    public AbstractNATSSerDe(RegistryClient client, SchemaResolver<T, U> schemaResolver) {
    ...
    protected void configure(BaseNATSSerDeConfig config, boolean isKey) {
        ...
        key = isKey;
        if (idHandler == null) {
            Object idh = config.getNATSIdHandler();
